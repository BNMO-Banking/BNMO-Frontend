...
<template>
    <div class="flex flex-col w-full gap-y-4 items-center xl:items-baseline">
        <span
        ...
        <h1 class="text-center xl:text-left">{{ fullName }}</h1>
        <hr class="border-2 border-main-green w-full" />
        <div class="flex flex-col xl:flex-row items-center gap-x-16 gap-y-4 xl:gap-y-0 py-4">
