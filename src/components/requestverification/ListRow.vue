...
<template>
    <div
        ...
        "
    >
        <input :class="width[0]" class="w-4 h-4" type="checkbox" />
        ...
        <div :class="width[3]" class="flex flex-col border-r-2 border-black">
            ...
            <div class="flex gap-x-2">
                ...
                <p>:</p>
                <div class="overflow-auto w-[70%] h-[4.5rem] max-h-[4.5rem]">
                    {{ data.remarks || "No remarks" }}
                </div>
            </div>
        </div>
        <div :class="width[4]" class="flex justify-center gap-x-4">
            <button class="action-yes">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
