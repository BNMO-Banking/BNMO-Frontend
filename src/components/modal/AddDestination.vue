...
watch(
    [errorCheckDestination, invalidNumber],
    () => {
    ...
    >
        ...
        >
            ...
            <div class="flex flex-col w-full">
                <ValuedTextInput 
                    v-model:input-value="requestedNumber" 
            ...
            <h4 class="font-bold text-main-red uppercase w-full m-4" v-if="invalidNumber && !isLoadingCheckDestination">
                {{ errMessage }}
            </h4>
