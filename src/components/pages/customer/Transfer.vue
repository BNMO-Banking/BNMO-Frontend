...
const { transferDestinations, isLoadingDestinations, errorDestinations } =
...
<template>
    ...
    />
    <h1 class="text-6xl font-extrabold uppercase text-center m-8">- Transfer -</h1>
    ...
    <main class="flex flex-1 items-center justify-center gap-x-8">
        <div class="flex flex-col p-4 shadow-md w-2/5 border-2 border-main-blue gap-y-4">
            <div class="flex items-center gap-x-4">
                ...
                <h2 class="text-3xl font-extrabold uppercase">Transfer balance</h2>
            </div>
            ...
            <button class="normal-button bg-main-red border-main-red" type="submit" disabled v-else>
                Transfer
            </button>
        </div>
    </main>
