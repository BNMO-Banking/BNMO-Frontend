...
<template>
    <main class="flex flex-col flex-1 w-full">
        ...
        <table class="mx-8 mb-6">
            ...
            <tbody class="text-center">
                <RequestVerificationRow
                    ...
                    v-for="(data, index) in pendingRequests"
                    :key="data.ID"
                    :data="data"
        ...
        <svg v-if="isLoadingPendingRequests" aria-hidden="true" class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
