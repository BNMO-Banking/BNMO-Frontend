...
<template>
    <main class="flex flex-col flex-1 w-full">
        ...
        <div class="flex w-full items-center justify-center">
            <svg v-if="isLoadingPendingRequests" aria-hidden="true" class="w-16 h-16 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-main-green" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
