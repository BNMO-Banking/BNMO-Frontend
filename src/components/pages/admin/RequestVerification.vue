...
const { pendingRequests, pageMetadata, isLoadingPendingRequests, errorPendingRequests } =
    storeToRefs(store);
        ...
        <table class="mx-8 mb-6">
            <thead class="border bg-main-green" v-once>
                <tr>
                    ...
                    <th scope="col" class="p-4 w-[15%] text-lg">Account Number</th>
            ...
            <tbody v-if="pendingRequests.length !== 0" class="text-center">
