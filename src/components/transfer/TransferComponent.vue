...
<template>
    ...
    />
    <div
        class="grid grid-cols-1 p-4 shadow-md border-2 border-main-blue gap-y-4 justify-self-center"
        :class="form.destination_number ? `grid-rows-auto-8` : `grid-rows-auto-7`"
    >
